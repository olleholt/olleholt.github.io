...
![](images/lm_reg_plot.png)

### Time Series Analysis

Next I did a time series analysis to view the linear trendlines over time. From the plots below, we could imply chlorophyll is relatively stable over time and that clarity is decreasing. This data only has measurements until 2019 and from recent reports, clarity levels have actually been increasing since 2020.

In 2022, the average annual clarity of Lake Tahoe was 71.7 feet, compared to 61 feet observed in 2021. A highlight of 2022 was the substantial improvement in lake clarity observed from August through December, with an average Secchi depth of 80.6 feet. This improvement coincided with the peak abundance of zooplankton, particularly Daphnia and Bosmina.
